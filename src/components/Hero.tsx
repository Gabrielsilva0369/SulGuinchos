  ...
  return (
    <section id="inicio" className="hero">
      <div className="hero__media">
        <img
          className="hero__img"
          src="/assets/hero-sul-guinchos.webp"
          alt="Caminhão da Sul Guinchos preparado para atendimento 24 horas"
          width={941}
          height={1672}
          loading="eager"
          decoding="async"
      ...
      <div className="hero__content">
        <h1 className="hero__title">
          <span className="hero__title-guincho">GUINCHO</span>
          <span className="hero__title-24h">24H</span>
        </h1>
        ...
        <a
          ...
          aria-label="Chamar a Sul Guinchos no WhatsApp"
        >
        ...
        <a
          ...
          onClick={trackCtaClick}
          aria-label="Ligar agora para a Sul Guinchos"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
