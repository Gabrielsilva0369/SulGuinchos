/* ==========================================================================
   Sul Guinchos — Impressão digital do aparelho (device_hash)
   --------------------------------------------------------------------------
   ...
   ⚠️ Não é 100% único no mobile (aparelhos do mesmo modelo colidem) e
...
function canvasSignal(): string {
  try {
    ...
    ctx.fillStyle = "#069";
    ctx.fillText("Sul Guinchos \u{1F6FB} fp", 2, 2);
    ctx.fillStyle = "rgba(102,0,255,0.5)";
    ctx.fillText("Sul Guinchos \u{1F6FB} fp", 4, 4);
    return c.toDataURL();
  } catch {
    return "";
  }
